...
1. Open `MetaForm.csproj` in Visual Studio 2022
2. Restore NuGet packages (automatically done on build)
3. Build the solution (Ctrl+Shift+B)
4. The output will be `MetaForm.gha` in the `bin` folder

### Installation

Copy `MetaForm.gha` to:
```
...
1. Open Grasshopper
2. Find the component: **Urban Design > Massing > Meta Form**
