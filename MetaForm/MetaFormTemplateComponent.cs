...
namespace MetaForm
{
    public class MetaFormTemplateComponent : GH_Component
    {
        private List<string> folderList = new List<string>();
        private List<List<string>> filesList = new List<List<string>>();

        public MetaFormTemplateComponent()
          : base("MetaForm Template", "Template",
              "MetaForm template files for quick starting",
              "MetaForm", "Main")
        {
        }
        ...
        protected override Bitmap Icon => Properties.Resources.template_icon;

        protected override void RegisterInputParams(GH_InputParamManager pManager)
        {
            pManager.AddTextParameter("Directory", "Dir", "Additional folder path to import MetaForm templates.", GH_ParamAccess.list);
            pManager[0].Optional = true;
        }

        protected override void RegisterOutputParams(GH_OutputParamManager pManager)
        {
            pManager.AddTextParameter("Templates", "T", "MetaForm templates found in folders.", GH_ParamAccess.list);
        }
        ...
        {
            m_attributes = new MetaFormTemplateAttributes(this);
        }
    }

    public class MetaFormTemplateAttributes : GH_ComponentAttributes
    {
        public MetaFormTemplateAttributes(GH_Component owner) : base(owner)
        {
        }
