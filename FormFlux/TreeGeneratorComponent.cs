...
{
    /// <summary>
    /// Tree configuration component that provides tree parameters to FormFlux
    /// </summary>
    public class TreeGeneratorComponent : GH_Component
    {
        ...
        {
            pManager.AddTextParameter("Trees", "Trees", "Tree configuration data for FormFlux", GH_ParamAccess.item);
        }
